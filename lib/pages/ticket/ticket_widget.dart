...
class _TicketWidgetState extends State<TicketWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      logFirebaseEvent('Ticket_firestore_query');
      _model.checkViolatorQuery = await queryCitationRecordOnce(
                                                          ...
                                                          enabledBorder:
                                                            ...
                                                            borderSide:
                                                              ...
                                                              color:
                                                                  valueOrDefault<
                                                                      Color>(
                                                                _model.checkViolatorQuery?.violatorLicenseNum ==
                                                                        _model
                                                                            .violatorLicenseNumTextController
                                                                            .text
                                                                    ? FlutterFlowTheme.of(
                                      ...
                                      children: [
                                        Builder(
                                          builder: (context) => FFButtonWidget(
                                            onPressed: ((_model.violatorNameTextController
                                                                .text ==
                                                            '') ||
                                                    (_model.violatorGenderValue ==
                                                            null ||
                                    ...
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            controller:
                                                _model.vehicleDecTextController,
                                            focusNode:
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: FFButtonWidget(
                                          onPressed: ((_model.vehiclePlateNumTextController
                                                              .text ==
                                                          '') ||
                                                  (_model.vehicleSerialNumTextController
                                                              .text ==
