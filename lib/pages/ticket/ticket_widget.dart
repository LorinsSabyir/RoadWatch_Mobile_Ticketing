...
class _TicketWidgetState extends State<TicketWidget> {
  ...
  void initState() {
    ...
    _model.violatorLicenseNumFocusNode!.addListener(() => safeSetState(() {}));
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<CitationRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<CitationRecord> ticketCitationRecordList = snapshot.data!;
                                                            ...
                                                            onChanged: (_) =>
                                                              ...
                                                              () async {
                                                                ...
                                                                for (int loop1Index =
                                                                        0;
                                                                    loop1Index <
                                                                        ticketCitationRecordList
                                                                            .map((e) =>
                                                                                e.violatorName)
                                                                            .toList()
                                                                            .length;
                                                                    loop1Index++) {
                                                                  final currentLoop1Item = ticketCitationRecordList
                                                                      .map((e) =>
                                                                          e.violatorName)
                                                                      .toList()[loop1Index];
                                                                  if (currentLoop1Item ==
